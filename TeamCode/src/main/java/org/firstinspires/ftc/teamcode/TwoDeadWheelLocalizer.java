...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -9796.971883553992; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -6578.058554958856; // x position of the perpendicular encoder (in tick units)
    }
